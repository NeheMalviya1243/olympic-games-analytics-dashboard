...
def most_successful(df, sport):
    ...
    result = medal_counts.merge(df, left_on='Name', right_on='Name', how='left')[['Name', 'Medals', 'Sport', 'region']]
...
def most_successful_countrywise(df, country):
    ...
    medal_counts = temp_df['Name'].value_counts().reset_index()
    medal_counts.columns = ['Name', 'Medals']
    result = medal_counts.head(10).merge(df[['Name', 'Sport', 'region']], on='Name', how='left').drop_duplicates(subset='Name')
    return result
